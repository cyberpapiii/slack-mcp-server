...
var dailyPowerToolBehavior = map[string]ToolBehavior{
	...
	"files_upload":              {Title: "Upload File", OpenWorld: true},
	"messages_schedule":         {Title: "Schedule Message", OpenWorld: true},
	...
	"channels_create":           {Title: "Create Channel", OpenWorld: true},
	"channels_members":          {Title: "List Channel Members", ReadOnly: true, Idempotent: true, OpenWorld: true},
	"channels_invite":           {Title: "Invite Channel Members", OpenWorld: true},
	...
	"users_set_status":          {Title: "Set User Status", OpenWorld: true},
	"canvases_create":           {Title: "Create Canvas", OpenWorld: true},
	...
	"drafts_create":             {Title: "Create Draft", OpenWorld: true},
