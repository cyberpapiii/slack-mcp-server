...
| `SLACK_MCP_SERVER_CA_TOOLKIT`     | No        | `nil`                     | **Broken:** embedded HTTP Toolkit CA expired 2026-03-13; setting this fatals. Use `SLACK_MCP_SERVER_CA` with a current PEM for MitM debugging.                                                                                                                                           |
